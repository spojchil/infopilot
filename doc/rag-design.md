...
> InfoPilot 文档问答的核心能力。与 `prompt-engineering.md`（管 Prompt 写法）和 `context-engineering.md`（管上下文窗口）互补。
...
来源：[Blended RAG](https://arxiv.org/abs/2309.09966)、`doc/learning-roadmap.md` 阶段 4 中的混合检索讨论
...
来源：[LangChain4j — RAG Tutorial](https://docs.langchain4j.dev/tutorials/rag)、`C:\d\xiangmu\langchain4j-examples\rag-examples`
